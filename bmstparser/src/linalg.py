...
'''
    got this code from https://github.com/jcyk/Dynet-Biaffine-dependency-parser/blob/master/lib/utils.py
	adopted from Timothy Dozat https://github.com/tdozat/Parser/blob/master/lib/linalg.py
'''


def orthonormal_VanillaLSTMBuilder(builder, input_dims, lstm_hiddens):
